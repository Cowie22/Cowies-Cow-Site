...
class SignUpForm extends React.Component {
  ...
  handleInputChange = event => {
    ...
    if (event.target.name === 'firstName') {
      if (
        (!lettersBool || event.target.value.length > 50) &&
      ...
      if (
        (!lettersBool || event.target.value.length > 100) &&
        event.target.value.length !== 0
      ) {
        event.preventDefault()
        event.stopPropagation()
      ...
      if (
        (!numsBool || event.target.value.length > 10) &&
        event.target.value.length !== 0
      ) {
        event.preventDefault()
        event.stopPropagation()
                  ...
                  <Row>
                    ...
                    >
                      ...
                      <p className='text-center'>
                        Please provide the following information so we can put
                        you in touch with a Myfembree® representative in your
                        area.
                      </p>
                      ...
                      <div className='form-container'>
                        ...
                        >
                          <Row>
                            ...
                            <Col
                              lg={{ span: 5, offset: 1, order: 3 }}
                              xs={{ span: 10, offset: 1, order: 3 }}
                            >
                              <Form.Group
                                controlId='formHorizontalEmail'
                                className={
                                  submitClicked === true && email === ''
                                    ? 'invalid-group'
                                    : ''
                                }
                              >
                            ...
                            <Col
                              lg={{ span: 5, offset: 1, order: 5 }}
                              xs={{ span: 10, offset: 1, order: 5 }}
                            >
                              <Form.Group
                                controlId='form-hcp-dropdown'
                                ...
                                <select
                                  ...
                                  className={
                                    specialty === '' && submitClicked
                                      ? 'form-dropdown-select invalid-dropdown'
                            ...
                            >
                              <Form.Group
                                ...
                                className={
                                  submitClicked === true && confirmEmail === ''
                                    ? 'invalid-group'
                                    : ''
                                }
                              >
                                <Form.Label column>Confirm email*</Form.Label>
                                <Form.Control
                                  type='email'
                                  name='confirmEmail'
                                  value={confirmEmail}
                                  ...
                                  >
                                    ...
                                    <Form.Check.Label className='privacy-policy-container'>
                                      <p className='upper-concent-content'>
                                        ...
                                        you certify that you are a licensed
                                        healthcare provider, and you agree to
                                        have a Myfembree representative contact
                                        you. You also understand and agree that
                                        any information you provide on this form
                                    ...
                                    <Form.Control.Feedback
                                      type='invalid'
                                      className='concent-feedback-label'
                                    >
                ...
                >
                  ...
                  <Row>
                    <Col
                      ...
                      xs={{ span: 10, offset: 1 }}
                    >
                      <h2 className='blue text-center'>Thank You</h2>
                      <p className='text-center'>
                        We have received your request for more information about
                        Myfembree® (relugolix, estradiol, and norethindrone
                        acetate) tablets. A Myfembree representative in your
                        area will follow up soon to get you the information you
                        need.
                      </p>
                    </Col>
                  </Row>
