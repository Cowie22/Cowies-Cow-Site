  ...
  return (
    <Col lg={{ span: 12, offset: 0 }}>
      <div
        className={
          !expanded
            ? 'expand-card-container not-expanded-container'
      ...
      >
        ...
        <div
          className={
            !expanded
              ? 'expand-card-content-container not-expanded'
              : 'expand-card-content-container'
          }
        >
          <Row>
            <Col lg={{ span: 10, offset: 1 }}>
              <p>
                <strong>LIBERTY 1 and 2:</strong> Two replicate, 24-week,
                randomized, double-blind, placebo-controlled clinical trials
                that enrolled premenopausal women with heavy menstrual bleeding
                associated with uterine fibroids.<sup>1</sup>
              </p>
              <p>
              ...
              <p>
                <strong>Key secondary endpoints included:</strong> Mean
              ...
              <p>
                ...
                1 and 2. An additional endpoint included change in menstrual blood loss volume at
                52 weeks.<sup>3</sup>
              </p>
            </Col>
          </Row>
                ...
                <Link to={`/liberty-trials/`}>
                  <button className='cta-btn transparent-btn-pink'>
                    <div className='btn-content-container'>
                      <p>See Trial Design Page for Full Details</p>
                      <div className='btn-arrow-container'>
                        ...
                        >
                          <path
                            className={
                              hovered ? 'btn-arrow active-arrow' : 'btn-arrow'
                            }
                            fillRule='evenodd'
                            clipRule='evenodd'
