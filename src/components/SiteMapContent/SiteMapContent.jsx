          ...
          <Row>
            <Col lg={{ span: 12 }}>
              <ul className='purple-ul sitemap-ul'>
                ...
                <li>
                  <Link to='/liberty-trials/'>Efficacy</Link>
                  <ul className='purple-ul-dashed sitemap-ul'>
                    <li>
                      <Link to='/liberty-trials/'>LIBERTY Trials</Link>
                    </li>
                    <li>
                      <Link to='/efficacy-data/'>Efficacy Data</Link>
                    </li>
                  </ul>
                </li>
                <li>
                  <Link to='/safety-profile/'>Safety</Link>
                </li>
                <li>
