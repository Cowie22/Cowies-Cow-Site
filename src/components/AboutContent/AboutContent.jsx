              ...
              <Row>
                ...
                <CircleTypeCard
                  ...
                  image={
                    ...
                    <path d="M94 4C143.706 4 184 44.2944 184 94" stroke="" stroke-width="8" stroke-linecap="round" className={circleInViewAbout ? 'yellow-line' : ''} />
                ...
                <CircleTypeCard
                  ...
                  image={
                    <svg width="188" height="188" viewBox="0 0 188 188" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="94" cy="94" r="90" stroke="#997F8A" stroke-width="2"/>
                    <path d="M94 4C117.782 4 139.409 13.2242 155.5 28.29" stroke="#E3FF39" stroke-width="8" stroke-linecap="round" className={circleInViewAbout2 ? 'yellow-line' : ''} />
                ...
                <CircleTypeCard
                  ...
                  image={
                    <svg width="188" height="188" viewBox="0 0 188 188" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="94" cy="94" r="90" stroke="#997F8A" stroke-width="2"/>
                    <path d="M94 4C143.706 4 184 44.2944 184 94C184 143.706 143.706 184 94 184C68.1866 184 44.9114 173.133 28.5 155.724" stroke="" stroke-width="8" stroke-linecap="round" className={circleInViewAbout3 ? 'yellow-line' : ''} />
