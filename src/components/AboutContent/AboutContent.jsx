            ...
            <Col lg={{span: 12, offset: 0}}>
              ...
              <Row ref={setRefs}>
                ...
                <CircleTypeCard
                  ...
                  image={
                    <svg width="189" height="189" viewBox="0 0 189 189" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="94.3334" cy="95" r="90" stroke="" stroke-width="2" className={circleInViewAbout ? 'full-circle-line' : ''} />
                    ...
                    <path d="M94.3334 5.98798C94.3334 3.2332 96.5686 0.986194 99.3195 1.13223C119.767 2.21771 139.307 9.95421 154.956 23.1601C157.061 24.9368 157.152 28.1049 155.266 30.113C153.381 32.1212 150.233 32.2074 148.116 30.444C134.333 18.96 117.228 12.1878 99.319 11.1239C96.5691 10.9605 94.3334 8.74276 94.3334 5.98798Z" fill="" className={circleInViewAbout ? 'yellow-line' : ''} />
                ...
                <CircleTypeCard
                  ...
                  image={
                    ...
                    <circle cx="94.6667" cy="95" r="90" stroke="" stroke-width="2" className={circleInViewAbout ? 'full-circle-line' : ''} />
                    ...
                    <path d="M94.6667 5.98798C94.6667 3.2332 96.9017 0.986198 99.6526 1.1323C113.51 1.86829 127.054 5.66498 139.303 12.274C153.018 19.6739 164.677 30.3672 173.233 43.3918C181.788 56.4165 186.972 71.3639 188.316 86.8891C189.661 102.414 187.125 118.03 180.936 132.332C174.747 146.634 165.099 159.172 152.862 168.82C140.624 178.467 126.179 184.921 110.828 187.6C95.4768 190.28 79.7003 189.1 64.9179 184.168C51.7153 179.764 39.6757 172.489 29.6532 162.891C27.6636 160.986 27.7716 157.819 29.7798 155.933C31.7879 154.047 34.9347 154.158 36.9363 156.051C45.8181 164.45 56.4415 170.824 68.0751 174.705C81.2886 179.114 95.3909 180.168 109.113 177.773C122.835 175.378 135.746 169.609 146.686 160.985C157.625 152.362 166.248 141.154 171.78 128.37C177.312 115.586 179.579 101.627 178.377 87.7499C177.175 73.8723 172.542 60.5113 164.895 48.8689C157.247 37.2265 146.825 27.668 134.566 21.0535C123.773 15.2299 111.854 11.8492 99.6519 11.124C96.902 10.9605 94.6667 8.74276 94.6667 5.98798Z" fill="" className={circleInViewAbout ? 'yellow-line' : ''} />
