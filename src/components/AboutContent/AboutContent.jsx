                  ...
                  <Row>
                    ...
                    >
                      <div
                        className={
                          boxInView
                            ? `about-circle-rectangle-callout active-card`
                            : `about-circle-rectangle-callout`
                        }
                      >
                        <Row>
                          <Col
                          ...
                          >
                            <h3 className='text-center'>
                              The incidence of NPC type 2 has been increasing by
                              approximately 3% annually in the US.<sup>5</sup>
                            </h3>
                          </Col>
                        </Row>
                      </div>
              ...
              <Row>
                <Col lg={{ span: 12, offset: 0 }}>
                  <DemographicsCards
                    ...
                    text={
                      <>
                        to be diagnosed with NPC worldwide<sup>2</sup>
                      </>
                    }
                  />
                  <DemographicsCards
                    ...
                    text={
                      <>
                        although it can be diagnosed at any age<sup>1</sup>
                      </>
                    }
                  />
                  <DemographicsCards
                    ...
                    text={
                      <>
                        is diagnosed per year in the US<sup>1</sup>
                      </>
                    }
                  />
                  <div
                    ...
                    className={
                      raceCardInView
                        ? `demographic-race-card-container active-race-card`
                        : `demographic-race-card-container`
                    }
                  >
                    <Row>
                      <Col
                        lg={{ span: 2, offset: 1 }}
                        className='demographic-left-card-col'
                      >
                        <div className='demographic-left-card-container'>
                          <h3 className='white text-center'>RACE</h3>
                        </div>
                      </Col>
                  ...
                  <DemographicsCards
                    ...
                    text={
                      <>
                        in the US, but type 2 is increasing<sup>2</sup>
                      </>
                    }
                  />
                </Col>
                  ...
                  <Row>
                    ...
                    <Col lg={{ span: 6, offset: 0 }} ref={setBoxRef2}>
                      <div
                        className={
                          boxInView2
                            ? `about-diagnosis-card-container active-card`
                            : `about-diagnosis-card-container`
                        }
                      >
                        <p className='white bolder'>HOW IS NPC DIAGNOSED?</p>
                        <p className='white'>
              ...
              <Row>
                <Col lg={{ span: 10, offset: 1 }}>
                  <div className='about-risk-title-container'>
                    <h2>Risk factors for nasopharyngeal carcinoma</h2>
                    <p>
                      NPC is distinct from other cancers, in part due to its
              ...
              <Row>
                <Col lg={{ span: 10, offset: 1 }} ref={setBoxRef3}>
                  <div
                    className={
                      boxInView3
                        ? `about-risk-rectangle-callout active-card`
                        : `about-risk-rectangle-callout`
                    }
                  >
                    <h3 className='text-center'>
